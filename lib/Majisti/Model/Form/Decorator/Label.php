...
namespace Majisti\Model\Form\Decorator;
...
class Label extends \Zend_Form_Decorator_Label
{
	...
	{
		if( null === $this->_markedAsRequired 
                && ($option = $this->getOption('markedAsRequired')) !== null )
        {
	...
	public function getLabel()
	{
        ...
        $tooltip = $translator == null 
            ? 'Mendatory field'
            : $translator->translate('Mendatory field');
