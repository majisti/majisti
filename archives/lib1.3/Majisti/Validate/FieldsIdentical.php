<?php 
/**
 * Use this validator until Zend releases an official one.
 * 
 * Validate that two (or more) fields have the same value.
 * 
 * @author (IRC) r3dd0 (???)
 */
...
class Majisti_Validate_FieldsIdentical extends Zend_Validate_Abstract {
