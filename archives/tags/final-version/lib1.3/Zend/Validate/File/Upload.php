...
class Zend_Validate_File_Upload extends Zend_Validate_Abstract
{
    ...
    public function isValid($value, $file = null)
    {
        ...
        foreach ($files as $file => $content) {
            ...
            // FIX throws an unhandled exception if file size is > max_file_size (yr - 2009-06-08)
            // see also Zend_File_Transfer_Adapter_Abstract line 589
            if (!isset($content['error'])) $content['error'] = 0;
        	if (!isset($content['tmp_name'])) $content['tmp_name'] = null;
