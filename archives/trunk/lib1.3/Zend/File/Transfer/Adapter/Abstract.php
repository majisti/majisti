        ...
        foreach ($check as $key => $content) {
            ...
            if (array_key_exists('validators', $content)) {
                foreach ($content['validators'] as $class) {
                    ...
                    // FIX throw exception if file > max_file_size (yr - 2009-06-08)
                    // see also Zend_Validate_File_Upload line 168
                    $tocheck = isset($content['tmp_name']) ? $content['tmp_name'] : null;
